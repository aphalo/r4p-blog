...
lr([**light**<br>raw-counts HDR]) --replace bad pixels<br>replace clipped by NA<br>linearize--> ll[**light**<br>linearised raw HDR]
-->|occluded pixels corr.<br>divide by<br>integration time| lc[**light**<br>cps HDR] 
--splice<br>slit fun. corr.<br>_despike_--> l[**light**<br>cps spliced]

dr([**dark**<br>raw-counts HDR]) --replace bad pixels<br>dark QC<br>linearize--> dl[**dark**<br>linearised raw HDR]
-->|occluded pixels corr.<br>divide by<br>integration time| dc[**dark**<br>cps HDR] 
--_splice_<br>slit fun. corr.<br>_despike_--> d[**dark**<br>cps _spliced_]

fr([**filter**<br>raw-counts HDR]) --replace bad pixels<br>replace clipped by NA<br>dark QC<br>linearize
--> fl[**filter**<br>linearised raw HDR]
-->|occluded pixels corr.<br>divide by<br>integration time| fc[**filter**<br>cps HDR] 
--splice<br>slit fun. corr.<br>_despike_--> f[**filter**<br>cps spliced]

l --> lm(("subtract<br>dark")) --> ldc[**light** cps<br>dark-corrected]
d --> lm
f --> fm(("subtract<br>dark")) --> fdc[**filter** cps<br>dark-corrected]
d --> fm

ldc --> slc(("stray light<br>correction")) --> cc[**light** cps<br>filter-corrected]
fdc --> slc

cc --mutiply by<br>calibration factors--> irrad([**spectral<br>irradiance**])
irrad -.->|_smooth_|sirrad([_smoothed_<br>**spectral<br>irradiance**]) 
...
ldc --mutiply by<br>calibration factors--> irrad([**spectral<br>irradiance**])
irrad -.->|_smooth_|sirrad([_smoothed_<br>**spectral<br>irradiance**]) 
...
l --> lm(("subtract<br>internal<br>dark")) --> ldc[**light** cps<br>dark-corrected]
...
l --> lm(("subtract<br>internal<br>dark")) --> ldc[**light** cps<br>dark-corrected]
f --> fm(("subtract<br>internal<br>dark")) --> fdc[**filter** cps<br>dark-corrected]
