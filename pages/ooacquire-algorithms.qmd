...
The zoomed-in plot shows that there is more noise remaining, including much more variation among neighbouring pixels as a `"dark"` reference as used in the sections above provides dark noise measurements for each pixel, the internal dark reference is an average from multiple pixels outside those included in the irradiance spectrum.
