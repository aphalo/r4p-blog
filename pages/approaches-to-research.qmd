...
%%{init: {"htmlLabels": true} }%%
flowchart TD
  Z([background information]) ==> Y(Hypothesis)
  ...
  H == {1.} ==> I[_QC_ **EDA**]
  H ==deposit
  data+metadata=====> X([data repository])
  I ==> G(**CDA** Tests of Hypothesis) == _P_-value ==> E
  E -- follow up study --> Y
  C <-- new/modified hypothesis --> Y
  C -- improved design --> A 
  I -- improved design --> A
  B <-.-> H
  A -.-o D
