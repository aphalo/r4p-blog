...
The use of the [Scientific Method](https://plato.stanford.edu/entries/scientific-method/) separates science from pseudo-science. However, there are different views among philosophers of science about how narrow and strict the definition of _scientiifc method_ should be. 
...
John Tukey argues that _lack of effect_ is a practical impossibility, for our example that plants of the two genotypes would have exactly the same height. Thus, accepting _no effect_ or _no difference_ as the result of a test is nonsensical. So we may reject or not the null hypothesis, but non-rejection does not mean acceptance, it means not enough information is available to make a decision, for our example deciding plant of which geneotype are taller. 
