...
This page lists all the R packages that I maintain and have authored. To access the documentation please use the menu above.

Those packages listed below with a green CRAN badge are available from this repository, which is used by R by default. The sources are maintained in public Git repositories. Git is a *revision control system* used to keep track of changes made to the package R code and its documentation. Until a couple of years ago, the public repositories of my packaged had been hosted at Bitbucket. Nowadays, they are all hosted at GitHub. Most R packages are currently at GitHub. It is nowadays easy to set up automated code tests under different R versions and operating systems (Windows, Linux and OS X). It also makes it possible to maintain a CRAN-like repo with source and binaries for packages through the [R Universe](https://ropensci.org/r-universe/) to distribute packages that do not fulfil the requirements for being hosted at CRAN or that are pre-releases still under development. Since late January 2024 the latest version of all the packages listed in this page can be also installed from my new repository at [https://aphalo.r-universe.dev](https://aphalo.r-universe.dev). **This repository replaces the soon to be closed repository at [https://r.r4photobiology.info](https://r.r4photobiology.info).**
