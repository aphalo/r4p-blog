...
categories: [R packages, documentation, R for Photobiology]
keywords: [R, photobiology, solar radiation, artificial light, spectra]
toc: true
editor: 
  markdown: 
    wrap: 72
abstract: |
  The 'R for Photobiology Suite' is a collection of R packages developed to facilitate various computations of interest in photobiology of plants. Many of the functions are useful in other fields, such as general photobiology, terrestrial solar radiation climatology and meteorology, artificial illumination, ecology and phenology research, etc. The design emphasizes reproducibility and easy of use. They are meant to be used both in original research, practical exercises in teaching and the preparation of teaching materials. References are given to primary sources of data and algorithms when available. This page summarizes the role of each package in the suite and links to their documentation web sites. 
---

![](r4p-logo.png){fig-align="left" width="33%" fig-alt="Square-shaped logo. White letter R and green letter lambda on a blue background."}

## Introduction

Packages in the suite provide functions, methods and data that are widely useful in photobiology and in
...
COST Action FA9604 'UV4Growth', funded by EU, facilitated
discussions and exchanges of ideas that lead to the development of the
_R for Photobiology_ suite of packages and its documentation. 

The contributions of ideas by Andy McLeod, Lars Olof Björn, Nigel Paul, Lasse
Ylianttila, Andreas Albert, Anders Lindfors, Glen Davis, Agnese Fazio, T.
Matthew Robson, Titta Kotilainen, and Maxime Durand were specially significant.
Other members of the UV4Plants Association (<https://www.uv4plants.org/>) and
participants in workshops and training events contributed both problems in need
of being solved and algorithms to implement or shared their data.
...
Beleites, C. and Sergo, V. (nd) `hyperSpec: a package to handle 
hyperspectral data sets in R', R package version 0.100.3.
