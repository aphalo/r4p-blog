...
![logo](r4p-logo.png){fig-align="left" width="33%"}
...
'ggplot2'. Two additional packages
(['**rOmniDriver**'](https://docs.r4photobiology.info/rOmniDriver/)) and
(['**ooacquire**'](https://docs.r4photobiology.info/ooacquire/)) make it
possible to acquire spectral data by controlling *Ocean Insight/Ocean
Optics* spectrometers from within R.
...
package has its own public Git repository at my Bitbucket or GitHub
accounts (<https://bitbucket.org/aphalo/>, <https://github.com/aphalo/>)
from where the source code of the current and earlier versions can be
cloned or forked.
