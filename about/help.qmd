...
The site has three tables of contents for [Blog](../posts.qmd), [Pages](../pages.qmd) and [Galleries](../galleries.qmd). These tables give the **Modified** Date, Creation **Date** and **Title** of all pages.

The _Default_ sort order is by _Modified Date_ with most recent contents at the top of the tables. A drop down menu allows sorting by Creation _Date_ or _Title_. A _Filter_ text box provides a simple search of the titles.
