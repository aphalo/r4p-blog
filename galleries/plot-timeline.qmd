...
The earliest examples of timeline plots date from the 1,700's \autocite{Koponen2019}. Initially used to depict historical events, timeline plots are useful to describe any sequence of events and periods along a time axis. To be useful the events should be positioned proportionally, i.e., the distance along the timeline at which events are marked, should be proportional to the time interval separating these events \autocite{Koponen2019}.
