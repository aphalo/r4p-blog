...
::: callout-warning
The examples in this page make use of packages 'ggpmisc' (>= 0.5.5.9000) and
'ggpp' (>= 0.5.5) not yet available through CRAN. In 'ggpmisc' 0.5.4 and 0.5.5
