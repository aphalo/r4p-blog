...
ggplot(df2, aes(x, y)) +
  ...
  stat_poly_eq(formula = formula, geom = "richtext", hjust = 0)
```
...
ggplot(df2, aes(x, y2, linetype = group, grp.label = group)) +
  ...
  stat_poly_eq(aes(label = after_stat(paste("**", grp.label, ":**  ", 
                                      eq.label, sep = ""))),
               formula = formula, geom = "richtext", hjust = 0, vstep = 0.1)
```
...
ggplot(df2, aes(x, y2)) +
  ...
  stat_poly_eq(aes(label = after_stat(eq.label)),
               formula = formula, geom = "richtext", hjust = 0) +
...
ggplot(df2, aes(x, y2, fill = block)) +
  ...
  stat_poly_eq(use_label("R2"), 
               ...
               alpha = 0.33,
               formula = formula,
               geom = "richtext", hjust = 0, vstep = 0.1) +
...
ggplot(df3, aes(x, y)) +
  ...
  stat_poly_eq(formula = formula,
               mapping = use_label("eq"), geom = "richtext", hjust = 0)
```
...
ggplot(df3, aes(x, y)) +
  ...
  stat_poly_eq(mapping = use_label("R2", "eq", sep = ", "), 
               color = "blue", geom = "richtext", hjust = 0) +
  stat_poly_line(color = "red", 
                 orientation = "y") +
  stat_poly_eq(mapping = use_label("R2", "eq", sep = ", "), 
               color = "red", 
               orientation = "y",
               label.y = 11, geom = "richtext", hjust = 0)
```
...
ggplot(df3, aes(x, y)) +
  geom_point() +
  stat_quant_band() +
  stat_quant_eq(quantiles = 0.5, geom = "richtext", hjust = 0)
```
