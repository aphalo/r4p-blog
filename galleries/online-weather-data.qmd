...
::: callout-note
The content of this page was originally written for the Questions and Answers section of the [UV4Plants Bulletin](https://bulletin.uv4plants.org/) but was not published as the Bulletin ceased to be published.
:::
...
The [E-OBS](https://surfobs.climate.copernicus.eu)\autocite{Cornes2018}  covers Europe plus
...
A paper just published discusses satellite-retrieved UV-A data and its importance for biological research \autocite{Parisi2021}. Another paper, available only as a preprint, describes real-time UV-Index retrieval at high spatial and temporal resolution over the whole of Europe \autocite{Kosmopoulos2021}. An earlier paper is also of interest as it discusses some of the sources of bias in UV-irradiance retrieved from satellites \autocite{Arola2009}. Finally an agronomic paper of interest in relation to how biases in weather data retrieved from satellite observations can affect estimates of biological responses \autocite{Bai2010}.

Chapter 8 in my book \citetitle{Aphalo2020a} \autocite{Aphalo2020a} provides code examples and explanations for importing data from files using additional formats to those I have discussed here.
