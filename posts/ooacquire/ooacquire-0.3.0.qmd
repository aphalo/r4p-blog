---
title: "ooacquire 0.3.0/0.3.1/0.3.2/0.3.2-1"
subtitle: "Acquisition of time series of spectra and other recent enhancements"
...
As part of moving the site to Quarto I intend to write a single post to
describe multiple minor versions of the packages. In this case, all versions
in the 0.3.x series. I will update this same post in the case of minor
version updates, and start a new post when the first version in the 0.4.x
series is developed. I hope this will reduce the clutter and still provide
a good overview of progress. The details are listed in the 
[NEWS file](https://docs.r4photobiology.info/ooacquire/news/index.html).

:::

Versions 0.3.0, 0.3.1 and 0.3.2 are feature and bug-fix updates. Version 
0.3.2-1 adds some improvements to the user interface. Nearly all
changes are related to the interactive measurement of spectral irradiance with
function `acq_irrad_interactive()`. The logic of the current user interface
modes in described in detail in a [tutorial](../../pages/acq-irrad-tutorial.qmd). 

Some of the enhancements required changes to lower level functions so these
functions also have enhancements. Some of the bugs fixed affected all data
...
Already well tested by me with three different spectrometers and a few hundreds of 
measurements, as of 2023-04-18 I think version 0.3.2 is good for everyday use.
Future version 0.3.2-1 still needs a final round of testing.
