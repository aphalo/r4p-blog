---
title: "ggpp 0.5.0/0.5.1/0.5.2/0.5.3"
...
The new statistic `stat_functions()` implements ploting of multiple functions per layer and supports groups and facets, i.e., the grammar of graphics. Be aware that `stat_functions()` is under development and its interface may change in future versions.
