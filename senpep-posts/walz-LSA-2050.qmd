...
|:-----------|:-----------|:-----------|:-----------|:-----|
| LSA-2050    | 715 (25) | 770 (30)      | conc.    | 
| MPM-100     | 720      | 850           | conc.    |
| MPM-100/S^*^ | 650     | 940           | SPAD index |
| Dualex 4    | 720      | 810?          | conc.    |
| MC-100      | 650      | 930           | conc.    |
| CCM-200     | 650      | 930           | CCI index |
...
maximum (FWHM) given in parentheses when available. Instruments names followed
by ^*^ indicate that the author has no direct experience in their use. The
MPM-100 is also available in customized versions based on LEDs emitting at
...
## Data logging and data excahnge
